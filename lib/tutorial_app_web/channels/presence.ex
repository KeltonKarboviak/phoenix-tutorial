defmodule TutorialAppWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule TutorialApp.MyChannel do
        use TutorialAppWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :tutorial_app,
                        pubsub_server: TutorialApp.PubSub
end
